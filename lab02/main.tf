...
// data "ncloud_server_image" "hashicat" {
//   filter {
//     name   = "product_name"
//     values = ["ubuntu-18.04?"]
//     regex  = true
...
//   server_image_product_code = data.ncloud_server_image.hashicat.id
...
//   server_image_product_code = data.ncloud_server_image.hashicat.product_code
